...
const Alldepartments = () => {
    ...
    async function getdepartments(){
        try{
            const res = await fetch("http://localhost:9000/home/courses/", {
                method: "GET",
    ...
    return(
        <Fragment style = {{backgroundColor : '#F1ECEC'}}>
            ...
            <h1 style={{ textAlign: 'center', fontWeight: 'bold', fontSize : '27px' }}>Courses Information : Department wise</h1>
            <table className = "table mt-5" style={{ width: '80%', margin: '0 auto' }}>
                <thead style={{ textAlign: 'center' }}>
                    <tr>
                        ...
                        <th className="cell" style = {{border : '2px solid black', backgroundColor : '#A9C5EB'}}>Number of Distinct courses Offered</th>
                    </tr>
                </thead>
                <tbody style={{ textAlign: 'center' }}>
                    ...
                    departments.map((info, index) => (
                        <tr>
                            ...
                            <Link to= {`/home/course/${info.department}/`}>{info.department}</Link>
                            </td>
